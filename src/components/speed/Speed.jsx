  ...
  <Custom.Container>
    ...
    <Custom.Columns>
      ...
      <Custom.Column>
        ...
        <p>By streamlining the validation and transmission of information, Scope reduces transaction costs and error rates across all parties in the network<sup><a href='https://www.linkedin.com/pulse/decay-healthcare-system-trust-david-loney/' target='_new'>2</a></sup></p>
      </Custom.Column>
      <Custom.Column>
        <Custom.IconWrapper>
          <img
        ...
        <p>Physicians are expensive back-office workers, and high overhead costs put everyone at risk. Scope ensures their time is spent as wisely as possible</p>
